...
<div class="container">
    ...
    <form:form modelAttribute="accounts" action="${pageContext.request.contextPath}" method="post">
        <!-- Email input -->
        ...
        <!-- Submit button -->
        <button type="submit" class="btn btn-primary btn-block mb-4" style="margin-left: 550px;">Register</button>

        <!-- Register buttons -->
        <div class="text-center">
            <p Style="margin-left: 40px;">Have a account? <a href="/login">Login</a></p>
        </div>
    </form:form>
</div>
</body>
