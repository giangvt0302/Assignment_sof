...
<div class="container">
    <h1 class="mb-4" style="text-align: center">Chi tiết đơn hàng</h1>
    ...
    <table class="table">
        ...
        <tbody>
        <c:forEach items="${listSP}" var="ds" varStatus="i">
        <tr >
            <td>${i.index+1}</td>
            <td> <img src="${pageContext.request.contextPath}/image/${ds.hoaDonChiTietId.laptop.image}"
                      style="max-width: 150px; height: auto"></td>
            <td>${ds.hoaDonChiTietId.laptop.name}</td>
            <td>${ds.hoaDonChiTietId.laptop.price}</td>
            <td>${ds.soLuong}</td>
        </tr>
        </c:forEach>
